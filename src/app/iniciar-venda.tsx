...
// IniciarVendaScreen é um componente funcional simples.
export default function IniciarVendaScreen() {
  // A View centraliza o conteúdo do ecrã.
  return (
    <View style={styles.container}>
      <Text style={styles.title}>Iniciar Venda</Text>
    </View>
  );
}
